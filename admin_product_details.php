  ...
  <div>
   ...
   if($conn -> connect_error)
   {
      die("Connection Failed : ".$conn->connect_error);
         ...
         echo "<strong>Product Name:</strong> {$row['pro_name']}  <br><br> ".
         "<strong>Description:</strong> {$row['des']} <br><br> ".
   ...
   <div id="product_img">
      <img src="<?php echo $t; ?>" width="350px" height="370px">
    </div>
      
      <div style="transform: translateX(40%);">
      <form method="post" action="display_product.php">
         <input type="hidden" value="<?php echo $data; ?>" name="pname">
         <input type="submit" class="btn btn-primary" style="margin-right: 20px;padding: 10px 40px;  " value="Update">
      </form>

      <form method="post" action="delete_product.php">
         <input type="hidden" name="dpname" value="<?php echo $data ?>">
         <input type="submit" class="btn btn-danger" style="margin-right: 20px;padding: 10px 40px;  " value="Delete">
      </form></div>
   </div>
</body>
</html>